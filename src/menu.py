...
class Menu:
    def __init__(self, screen, ai_game, IDplayerSolo = '0'):
        ...
        self.score = None
        self.stage = None
        self.IDPlayerSolo = IDplayerSolo
        self.options = {
          'main': [
            MenuOption(screen, '1 Player', self.ai_game.new_classic_game_1_player), 
            MenuOption(screen, '2 Player', self.ai_game.new_classic_game_2_player),
            MenuOption(screen, 'Solo', self.ai_game.new_classic_game_solo),
    ...
    def open(self, mode, score=None, stage=None, IDplayer = '0'):
    ...
    def draw(self):
        ...
        elif self.mode == 'gameoverSolo':
            if(self.IDPlayerSolo == '0'):
                gameover_label = Settings().GAME_FONT_MENU.render('End  in  a  draw', True, (255, 255, 255))
            else:
                gameover_label = Settings().GAME_FONT_MENU.render('Player '+self.IDPlayerSolo+' win!', True, (255, 255, 255))
            self.screen.blit(gameover_label, gameover_label.get_rect(left=80, top=190))
